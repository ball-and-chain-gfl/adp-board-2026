...
/* content-width and centred, like the Avg chip, rather than filling the column right-aligned.
   Still dialled back a touch: these columns are reference, not the headline. */
td.site .cell{font-weight:600;font-size:12px;min-width:0;padding:3px 5px;opacity:.88;text-align:center}
