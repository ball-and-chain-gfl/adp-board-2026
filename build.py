...
/* ------------------------------------------------------------- narrow ---
   Below 1024px the four site columns are dropped. What's left is the consensus
   average, the player and ESPN - the three things you actually act on - and the
   chrome is condensed so as much of the board as possible is on screen at once
   with no sideways scrolling. No phone-specific layout: this is the same table,
   just tighter. */
